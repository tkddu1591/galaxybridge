...
USB를 빼면 기존에 연결돼 있던 Wi-Fi의 현재 경로를 복구합니다. M3 Pro·Galaxy S25 Ultra에서 Wi-Fi를 끄고 켜지 않은 채 분리한 시험에서는 약 0.79초에 Wi-Fi 경로가 돌아왔고, 약 1.09초에 새 HTTPS 요청이 성공했습니다. 이 시간은 해당 환경의 측정값입니다.
